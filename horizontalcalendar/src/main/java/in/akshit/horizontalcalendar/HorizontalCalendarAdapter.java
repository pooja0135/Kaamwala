...
class HorizontalCalendarAdapter extends RecyclerView.Adapter<HorizontalCalendarAdapter.MyViewHolder> {
    ...
    public HorizontalCalendarAdapter(ArrayList<HorizontalCalendarModel> list, Context mCtx,TextView text) {
        this.list = list;
        this.mCtx = mCtx;
        this.text = text;
    }
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        text.setText(sdf.format(model.getTimeinmilli()).split(" ")[1]+" "+sdf1.format(model.getTimeinmilli()).split("-")[2]);
