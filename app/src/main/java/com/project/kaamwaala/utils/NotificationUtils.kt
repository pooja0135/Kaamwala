...
fun NotificationManager.sendNotification(title:String ,messageBody: String, applicationContext: Context) {
    ...
    val contentIntent = Intent(applicationContext, MainActivity::class.java).putExtra("type","notifcation")
...
/*  val eggImage = BitmapFactory.decodeResource(
    ...
    val builder = NotificationCompat.Builder(
        ...
        applicationContext.getString(R.string.sacred_heart_notification_channel_id)
    )
