...
class AddUrlImageDialog() : DialogFragment()  {

    private var field: String? = null
    private var oldValue: String? = null
    private var callback: Onclick? = null
    lateinit var callback1: OnAddImageUrl
    ...
    fun setCallBack(callback: OnAddImageUrl)
    {
    ...
    companion object {
        ...
        fun newInstance(): AddUrlImageDialog {
            val f =
                AddUrlImageDialog()
            val args = Bundle()
            f.arguments = args
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        tvOk.setOnClickListener {
            ...
            if (etImageUrl.text.toString().isEmpty())
            {
                Toast.makeText(context, "Enter Image Url", Toast.LENGTH_SHORT).show()
            }
            else
            {
                dialog!!.dismiss()
                callback1.onClickImage(etImageUrl.text.toString())
            }
    ...
    override fun onCreateView(
        ...
        val rootView = inflater.inflate(R.layout.create_image_dialog, container)
